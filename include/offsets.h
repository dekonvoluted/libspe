...
const std::size_t OFFSET_PULSERREPDELAY         = 0x007A;   // Delay Value for Repetitive pulse (usec)
const std::size_t OFFSET_PULSERSEQSTARTWIDTH    = 0x007E;   // Start Width for Sequential pulse (usec)
const std::size_t OFFSET_PULSERSEQENDWIDTH      = 0x0082;   // End Width for Sequential pulse (usec)
const std::size_t OFFSET_PULSERSEQSTARTDELAY    = 0x0086;   // Start Delay for Sequential pulse (usec)
const std::size_t OFFSET_PULSERSEQENDDELAY      = 0x008A;   // End Delay for Sequential pulse (usec)
